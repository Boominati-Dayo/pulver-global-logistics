...
const originIcon = L.divIcon({
  html: `<div style="background:#2c00cc;color:white;padding:8px 12px;border-radius:20px;font-weight:bold;box-shadow:0 2px 8px rgba(0,0,0,0.3)">Origin</div>`,
...
const destIcon = L.divIcon({
  html: `<div style="background:#84cc16;color:white;padding:8px 12px;border-radius:20px;font-weight:bold;box-shadow:0 2px 8px rgba(0,0,0,0.3)">Destination</div>`,
  className: 'custom-marker',
  iconSize: [100, 30],
  iconAnchor: [50, 15]
});
...
const currentIcon = L.divIcon({
  html: `<div style="background:#5f33ff;color:white;padding:6px 10px;border-radius:20px;font-size:12px;font-weight:bold;box-shadow:0 2px 8px rgba(0,0,0,0.3);animation:pulse 2s infinite">Current</div>`,
  className: 'custom-marker',
  iconSize: [80, 26],
  iconAnchor: [40, 13]
});
        ...
        {loading && (
          <div className="absolute inset-0 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center z-10">
            <div className="text-center">
              <div className="animate-spin w-8 h-8 border-4 border-[#84cc16] border-t-transparent rounded-full mx-auto mb-2"></div>

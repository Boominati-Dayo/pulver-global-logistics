  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#2c00cc] via-[#160066] to-[#2c00cc] flex items-center justify-center px-4 overflow-hidden relative">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-[500px] h-[500px] bg-[#84cc16]/10 rounded-full blur-[100px] transition-all duration-1000 ease-out" />
        <div className="absolute top-20 left-10 w-72 h-72 bg-[#84cc16]/5 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-40 right-20 w-96 h-96 bg-[#5f33ff]/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>

      <div className="relative z-10 text-center max-w-5xl mx-auto py-12">
        <div className="relative mb-10">
          <h1 className="text-[120px] md:text-[180px] font-black text-transparent bg-clip-text bg-gradient-to-r from-[#84cc16] via-white to-[#84cc16] tracking-tighter drop-shadow-2xl" style={{ textShadow: '0 0 100px rgba(132,204,22,0.3)' }}>404</h1>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 md:p-14 border border-white/20 shadow-2xl">
          <div className="flex items-center justify-center w-24 h-24 bg-gradient-to-br from-[#84cc16]/30 to-[#a3e635]/30 rounded-full mx-auto mb-8 border border-white/10">
            <FaPlane className="text-[#84cc16] text-5xl animate-bounce-slow" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
            <Link href="/" className="group flex items-center justify-center gap-4 px-8 py-5 bg-gradient-to-r from-[#84cc16] to-[#a3e635] text-white font-bold rounded-2xl hover:shadow-2xl hover:-translate-y-1 transition-all shadow-xl">

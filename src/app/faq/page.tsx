...
const faqs = [
  ...
  { category: 'shipping', question: 'Do you ship internationally?', answer: 'Yes, we ship to 50+ countries worldwide. International shipping times and costs vary by destination, package size, and selected service. Customs duties may apply.' },

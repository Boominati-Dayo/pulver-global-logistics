...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/track`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    ...
    { url: `${BASE_URL}/accessibility`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.4 },
  ];
}

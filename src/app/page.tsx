...
const reviews = [
  { name: "Marcus Thompson", role: "Supply Chain Director", company: "TechFlow Industries", rating: 4, text: "Pulver Global Logistics transformed our cross-border shipping. Their tracking is real-time and incredibly reliable.", location: "London, UK" },
  { name: "Jennifer Nakamura", role: "Operations Manager", company: "Sakura Electronics", rating: 5, text: "The customs clearance process with Pulver Global is seamless. They handle all documentation professionally.", location: "Dubai, UAE" },
  { name: "Robert Chen", role: "Import/Export Manager", company: "Pacific Trade Co", rating: 3, text: "Reliable partner for international shipments. Had some delays on one shipment but overall decent service.", location: "Singapore" },
  { name: "Sarah Mitchell", role: "E-commerce Owner", company: "Urban Trends Boutique", rating: 5, text: "As a small business, I need a logistics partner I can trust. Pulver Global delivers every time.", location: "Berlin, Germany" },
  { name: "David Kowalski", role: "Logistics Coordinator", company: "Midwest Manufacturing", rating: 4, text: "Their warehouse management integration saved us hours of manual work every week.", location: "Toronto, Canada" },
  { name: "Amanda Price", role: "CEO", company: "GreenLeaf Organics", rating: 5, text: "Pulver Global's carbon-offset program aligns perfectly with our sustainability commitment.", location: "Sydney, Australia" },
  { name: "Michael Santos", role: "Procurement Manager", company: "Apex Construction", rating: 3, text: "Heavy equipment shipping requires expertise. Service was decent but communication could be better.", location: "Mumbai, India" },
  { name: "Emily Watson", role: "Fulfillment Lead", company: "HomeStyle Decor", rating: 4, text: "Competitive rates and reliable LTL services. Pulver Global is now our go-to logistics partner.", location: "São Paulo, Brazil" },
  { name: "James Okonkwo", role: "International Sales", company: "AfroTech Solutions", rating: 5, text: "Shipping to 8 African countries is now seamless with Pulver Global's expertise.", location: "Lagos, Nigeria" },
  { name: "Lisa Fernandez", role: "Pharma Operations", company: "MedCore Pharmaceuticals", rating: 4, text: "Temperature-controlled shipping for medical supplies is critical. Pulver Global delivers most of the time.", location: "Tokyo, Japan" },
  { name: "Kevin O'Brien", role: "Fleet Manager", company: "O'Brien Fresh Foods", rating: 4, text: "Perishable goods need speed and reliability. Pulver Global's refrigerated fleet is modern and dependable.", location: "Paris, France" },
  { name: "Priya Sharma", role: "Fashion Buyer", company: "Boutique Boulevard", rating: 5, text: "Fashion moves fast, and so does Pulver Global. Same-day delivery is a game-changer.", location: "Hong Kong" },
  { name: "Derek Hoffman", role: "Warehouse Manager", company: "Hoffman Distribution", rating: 3, text: "Decent service overall. Had a couple of tracking issues but they resolved them promptly.", location: "Amsterdam, Netherlands" },
  { name: "Michelle Park", role: "Operations Lead", company: "Pacific Commerce", rating: 4, text: "Good partner for small business shipping. Rates are fair and delivery is consistent.", location: "Seoul, South Korea" },
  { name: "Carlos Vega", role: "Supply Chain Analyst", company: "Vega Logistics Group", rating: 2, text: "Service was slower than expected during peak season. Not bad but room for improvement.", location: "Mexico City, Mexico" },
  { name: "Rachel Kim", role: "Procurement Officer", company: "Metro Supplies Co", rating: 5, text: "Excellent customer service and reliable deliveries. Pulver Global has been a great partner for our business.", location: "Cape Town, South Africa" },
];

const renderStars = (rating: number) => (
  Array.from({ length: 5 }, (_, i) => (
    <FaStar key={i} className={`text-sm ${i < rating ? 'text-[#84cc16]' : 'text-gray-300'}`} />
  ))
);
...
const deliveryOptions = [
  ...
  { icon: FaMapPin, title: 'Pulver Global Access Point', desc: 'Pickup at secure convenient locations.' },
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#2c00cc] via-[#160066] to-[#2c00cc] min-h-[650px] flex items-center overflow-hidden pt-[60px]">
        <div className="absolute inset-0">
          <img src="/assets/home-hero.webp" alt="Pulver Global Logistics" className="h-full w-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#2c00cc]/85 via-transparent to-[#160066]/80"></div>
        </div>
        <div className="absolute top-24 right-8 w-72 h-72 bg-[#84cc16]/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-8 left-8 w-96 h-96 bg-[#5f33ff]/30 rounded-full blur-3xl"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
                Pulver Global<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#84cc16] to-[#a3e635]">Logistics</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/track" className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-[#84cc16] to-[#a3e635] text-white font-bold rounded-full hover:shadow-xl hover:shadow-lime-500/30 transition-all">
            ...
            <div className="hidden lg:block">
              <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl transform rotate-1 hover:rotate-0 transition-transform duration-500">
                ...
                <form onSubmit={handleQuickTrack} className="space-y-4">
                  <input type="text" value={trackingNumber} onChange={e => setTrackingNumber(e.target.value)} placeholder="e.g. PGL123456" className="w-full px-5 py-3.5 rounded-xl bg-white/90 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#84cc16] text-lg" />
                  <button type="submit" disabled={isTracking} className="w-full py-3.5 bg-gradient-to-r from-[#84cc16] to-[#a3e635] text-white font-bold rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-2">
                    {isTracking ? <FaSpinner className="animate-spin" /> : <FaSearch />} {isTracking ? 'Tracking...' : 'Track Now'}
                  </button>
                </form>
                <p className="text-white/50 text-sm mt-5 text-center">Or call us: <span className="text-[#84cc16] font-bold">{phone}</span></p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Stats Bar */}
      <section className="bg-gradient-to-r from-[#2c00cc] to-[#5f33ff] py-8">
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#84cc16] font-semibold text-sm uppercase tracking-wider">Shipping Solutions</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#2c00cc] dark:text-white mt-2 mb-4">Flexible Shipping Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {bentoServices.map((service, index) => (
              <div key={index} className="group relative rounded-2xl p-7 overflow-hidden cursor-pointer border border-gray-100 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl max-md:hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-[#2c00cc] to-[#5f33ff] opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 100%)' }}></div>
                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5 bg-[#84cc16]/10 group-hover:bg-white/20 transition-colors duration-300">
                    <service.icon className="text-2xl text-[#84cc16] group-hover:text-white transition-colors duration-300" />
                  </div>
                  ...
                  <Link href={service.href} className="inline-flex items-center mt-4 text-sm font-medium text-[#84cc16] group-hover:text-white/60 transition-colors duration-300">
          ...
          <div className="text-center mt-12">
            <Link href="/services" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-[#84cc16] to-[#a3e635] text-white font-bold rounded-full hover:shadow-xl hover:shadow-lime-500/30 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=800&q=80" alt="Pulver Global Logistics" className="rounded-3xl shadow-2xl" />
              <div className="absolute -bottom-6 -right-6 bg-gradient-to-br from-[#84cc16] to-[#a3e635] rounded-2xl p-6 shadow-xl">
                <p className="text-4xl font-extrabold text-white">4+</p>
                <p className="text-white/90 text-sm font-medium">Years of Excellence</p>
              </div>
            </div>
            <div>
              <span className="text-[#84cc16] font-semibold text-sm uppercase tracking-wider">Why Choose Pulver Global</span>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                With 4 years of experience, Pulver Global Logistics has built a reputation for reliability, transparency, and exceptional service. We connect businesses to global markets with efficiency and care.
              </p>
              <div className="grid grid-cols-2 gap-5">
                {[
                  ...
                  <div key={index} className="flex items-start gap-3">
                    <div className="w-10 h-10 bg-[#84cc16]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                      <item.icon className="text-[#84cc16]" />
                    </div>
                    <div>
              ...
              <Link href="/about" className="inline-flex items-center mt-8 px-7 py-3.5 bg-[#2c00cc] dark:bg-[#84cc16] text-white dark:text-[#2c00cc] font-bold rounded-full hover:shadow-lg transition-all">
      ...
      <section className="py-16 bg-gradient-to-r from-[#2c00cc] to-[#5f33ff]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <span className="text-[#84cc16] font-semibold text-sm uppercase tracking-wider">Shipping Protection</span>
              ...
              <Link href="/services" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#84cc16] to-[#a3e635] text-white font-bold rounded-full hover:shadow-xl hover:shadow-lime-500/30 transition-all">
                Learn More <FaArrowRight className="text-sm" />
              </Link>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 border border-white/20">
                <FaShieldAlt className="text-3xl text-[#84cc16] mb-3" />
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 border border-white/20">
                <FaAward className="text-3xl text-[#84cc16] mb-3" />
      ...
      <section className="py-16 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#2c00cc] dark:text-white mb-3">Delivery Options</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {deliveryOptions.map((service, index) => (
              <div key={index} className="text-center p-5 rounded-xl bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors border border-gray-100 dark:border-gray-600">
                <service.icon className="text-2xl text-[#84cc16] mx-auto mb-3" />
                <h4 className="text-sm font-bold text-[#2c00cc] dark:text-white mb-1">{service.title}</h4>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 text-center">
          <span className="text-[#84cc16] font-semibold text-sm uppercase tracking-wider">Testimonials</span>
          <h2 className="text-3xl md:text-4xl font-bold text-[#2c00cc] dark:text-white mt-2 mb-4">What Our Clients Say</h2>
          ...
          <div className="flex gap-5 marquee-container">
            {[...reviews, ...reviews].map((review, index) => (
              <div key={index} className="flex-shrink-0 w-[370px] bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <FaQuoteLeft className="text-[#84cc16]/30 text-2xl mb-3" />
                ...
                <div className="flex items-center mt-auto pt-3 border-t border-gray-100 dark:border-gray-700">
                  <div className="w-10 h-10 bg-gradient-to-br from-[#84cc16] to-[#a3e635] rounded-full flex items-center justify-center text-white font-bold text-sm">
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center bg-white dark:bg-gray-800 rounded-full px-6 py-3 shadow-lg border border-gray-200 dark:border-gray-600">
            <span className="text-2xl font-bold text-[#84cc16] mr-2">4.2</span>
      ...
      <section className="py-20 bg-gradient-to-r from-[#84cc16] to-[#a3e635]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/80 mb-8">Experience global logistics excellence</p>

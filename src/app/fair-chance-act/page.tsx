    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
          <div className="flex items-start gap-4 p-4 bg-[#ea580c]/10 rounded-xl border border-[#ea580c]/20">
            <FaInfoCircle className="text-[#ea580c] text-2xl mt-0.5 flex-shrink-0" />
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              SwiftXpress Inc. is committed to providing equal employment opportunities to all applicants. In compliance with the Fair Chance Act, we do not discriminate based on criminal history unless it is job-related and consistent with business necessity.
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-bold text-[#1a365d] dark:text-white mb-4">Our Hiring Process</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#1a365d] dark:text-white mb-4">Your Rights</h2>
            ...
            <div className="mt-4 grid md:grid-cols-2 gap-4">
              {['Receive a copy of the background check report', 'Challenge any inaccuracies in the report', 'Provide evidence of rehabilitation', 'Request an individualized assessment'].map((right, i) => (
                <div key={i} className="flex items-start gap-3 bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
                  <FaUserCheck className="text-[#ea580c] mt-0.5 flex-shrink-0" />

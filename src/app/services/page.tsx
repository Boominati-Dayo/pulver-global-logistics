...
const allServices = [
  { icon: FaTruck, title: 'Ground Transport', desc: 'Worldwide coverage with reliable delivery solutions. We ensure your packages reach any destination safely and on time.', features: ['Worldwide coverage', 'Standard and express options', 'Real-time tracking', 'Door-to-door service'], price: 'From $9.99/pkg', image: '/assets/land-shipment.png', href: '/services/ground-transport' },
  { icon: FaPlane, title: 'Air Freight', desc: 'Fast air freight services worldwide. When speed matters, Pulver Global Logistics delivers with precision and reliability.', features: ['Worldwide coverage', 'Express 1-3 day delivery', 'Customs clearance included', 'Door-to-door service'], price: 'From $29.99/pkg', image: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=600&q=80', href: '/services/air-freight' },
...
export default function Services() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="bg-gradient-to-br from-[#2c00cc] via-[#160066] to-[#2c00cc] py-20 text-center relative overflow-hidden pt-[120px]">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#2c00cc]/80 to-[#2c00cc]"></div>
        <div className="relative">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Pulver Global Logistics Services</h1>
          <p className="text-lg text-white/70 max-w-2xl mx-auto px-4">Reliable logistics solutions worldwide. From domestic deliveries to international freight, we've got you covered.</p>
        </div>
      </div>
            ...
            <div key={index} className={`flex flex-col ${index % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-8 lg:gap-16`}>
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-2xl group h-full">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-[#84cc16] to-[#a3e635] rounded-xl flex items-center justify-center">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#84cc16] to-[#a3e635] rounded-2xl flex items-center justify-center shadow-md">
                    <service.icon className="text-2xl text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-[#2c00cc] dark:text-white">{service.title}</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-400 mb-6 text-lg leading-relaxed">{service.desc}</p>
                <ul className="space-y-3 mb-6">
                  {service.features.map((feature, idx) => (
                    <li key={idx} className="flex items-center">
                      <FaCheck className="text-[#84cc16] mr-3 flex-shrink-0" />
                      <span className="text-gray-700 dark:text-gray-300">{feature}</span>
                    </li>
                  ))}
                </ul>
                <Link href={service.href} className="inline-flex items-center px-6 py-3 bg-[#2c00cc] text-white font-bold rounded-full hover:bg-[#160066] transition-all hover:shadow-lg">
      ...
      <div className="bg-gradient-to-r from-[#84cc16] to-[#a3e635] py-16 text-center">
        <h2 className="text-3xl font-bold text-white mb-4">Ready to Get Started?</h2>
        <p className="text-white/80 mb-8">Contact us for a custom quote tailored to your needs</p>
        <Link href="/contact" className="inline-flex items-center px-8 py-4 bg-[#2c00cc] text-white font-bold rounded-full hover:bg-[#160066] transition-all">

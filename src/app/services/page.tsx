...
const allServices = [
  ...
  { icon: FaBolt, title: 'Express Delivery', desc: 'Same-day and next-day delivery for urgent shipments. When you need it now, SXI delivers.', features: ['Same-day delivery options', 'Next-day nationwide', 'Time-definite windows', 'Dedicated courier'], price: 'Varies by Distance', image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=600&q=80', href: '/services/express-delivery' },

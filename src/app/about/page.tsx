    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-[#ea580c] font-semibold text-sm uppercase tracking-wider">Our Mission</span>
              ...
              <div className="grid grid-cols-2 gap-5">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl">
                    <stat.icon className="text-2xl text-[#ea580c] mx-auto mb-2" />
                    <p className="text-2xl font-bold text-[#1a365d] dark:text-white">{stat.value}</p>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a365d] dark:text-white mb-4">Our Core Values</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm text-center hover:shadow-xl hover:-translate-y-1 transition-all">
                <div className="w-16 h-16 bg-gradient-to-br from-[#ea580c] to-[#f97316] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-orange-500/20">
                  <value.icon className="text-3xl text-white" />
                </div>
                <h3 className="text-xl font-bold text-[#1a365d] dark:text-white mb-3">{value.title}</h3>
                ...
                <div key={index} className="relative flex flex-col md:flex-row items-center">
                  <div className={`md:w-1/2 md:px-8 mb-4 md:mb-0 ${index % 2 === 0 ? 'md:text-right' : 'md:text-left md:order-3'}`}>
                    <div className={`bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 shadow-lg ${index % 2 === 0 ? 'md:ml-auto' : ''}`} style={{ maxWidth: '400px' }}>
                      <p className="text-3xl font-extrabold text-[#ea580c] mb-2">{milestone.year}</p>
                      <h3 className="text-xl font-bold text-[#1a365d] dark:text-white mb-2">{milestone.title}</h3>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">{milestone.desc}</p>
                    </div>
                  </div>
                  <div className="absolute left-1/2 transform -translate-x-1/2 w-5 h-5 bg-gradient-to-br from-[#ea580c] to-[#f97316] rounded-full border-4 border-white dark:border-gray-800 shadow-lg hidden md:block"></div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#1a365d] to-[#2c5282]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/70 mb-8">Experience the SXI difference today</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-[#ea580c] to-[#f97316] text-white font-bold rounded-full hover:shadow-xl hover:shadow-orange-500/30">
              Contact Us <FaArrowRight className="ml-2" />
            </Link>
            <Link href="/services" className="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white font-bold rounded-full hover:bg-white hover:text-[#1a365d] transition-all">
              View Services
            </Link>
          </div>
        </div>
